...
config :note_ify, NoteIfyWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "iyA4CHIg2TVSXb9qJYAfzMVFIzU63a/zrvT6zEfkHx4005bYeBQ5tEbayIwT6zEY",
  watchers: [
...
config :note_ify, NoteIfyWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/note_ify_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :note_ify, dev_routes: true
